  ...
  en: {
    ...
    marquee: {
      ...
      commands: [
        ...
        'Column Stirrups', 'Beam Rebar', 'Wall Rebar', 'Slab Rebar', 'Plumbing Fixtures',
    ...
    useCases: {
      ...
      visuals: {
        ...
        dwg: {
          caption: 'Before vs. after — DWG export (drag)',
    ...
    metrics: {
      ...
      subtitle: 'Figures anchored to specific tasks, based on the compared-times chart.',
      quickCaption: 'per compared-times chart',
      quickLabels: [
    ...
    roi: {
      ...
      hoursSuffix: ' h',
      ratePrefix: 'S/ ',
      note: { strong: 'Indicative estimate.', rest: ' Assumes an 80% time reduction on tasks BIMS automates (formwork, rebar, DWG export, grid assignment). Actual savings depend on each studio’s workflow.' },
    ...
    trial: {
      ...
      companyLabel: 'Company / Studio (optional)',
      companyPlaceholder: 'Construction firm, engineering studio, freelance…',
      pwLabel: 'Password *',
