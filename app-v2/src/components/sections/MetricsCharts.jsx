// ─────────────────────────────────────────────────────────────────────────────
// Las tres gráficas de la sección «efectividad», en su propio módulo.
//
// Están separadas de Metrics.jsx a propósito: Chart.js pesa unos 200 KB y antes
// viajaba dentro del bundle principal, así que TODO visitante lo descargaba y lo
// parseaba antes de ver la portada — aunque no bajara nunca hasta las gráficas.
// Ahora Metrics.jsx carga este módulo bajo demanda (React.lazy) y solo cuando la
// sección se acerca al viewport, así que Chart.js sale del camino crítico.
//
// Recibe `m` (los textos del idioma activo) y construye los datos a partir de
// data/metrics.js, igual que antes.
// ─────────────────────────────────────────────────────────────────────────────
...
import { CHART_TIME, CHART_ERROR, CHART_RADAR } from '../../data/metrics.js';
...
export default function MetricsCharts({ m }) {
